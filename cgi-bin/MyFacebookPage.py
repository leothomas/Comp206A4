...
print''' <td valign = \"bottom\" align = \"middle\" width= \"50%\" >
	<form name= \"statusUpdate\" action = \"http://cgi.cs.mcgill.ca/~lthoma13/Comp206A4/cgi-bin/MyFacebookPage.py\" method = \"POST\">
...
ListMembers(user)
print ''' <br><center><form name = "addFriend" action = \"http://cgi.cs.mcgill.ca/~lthoma13/Comp206A4/cgi-bin/MyFacebookPage.py\" method = "POST">
